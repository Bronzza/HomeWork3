...
public class Car {
    ...
    public void addPassenger() {
        if (passengersInside <= passengersQuantity) {
            ...
            System.out.println("garrage.Car is full");
        }
    }
    ...
    public void removePassenger() {
        if (passengersInside > 0) {
            ...
            System.out.println("garrage.Car is empty");
        }
    }
    ...
    public String toString() {
        return "This is garrage.Car, which is made in: " + creationDate + "; Engine is: " + engineType + "; maxspeed is: " +
